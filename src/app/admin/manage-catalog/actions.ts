...
const EDITABLE = ["title", "description", "category", "sub_category", "color", "primary_fabric", "hsn", "location", "wholesale_price", "min_order_qty", "current_qty", "restockable", "restock_days"] as const;
