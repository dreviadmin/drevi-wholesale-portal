  ...
  return (
    <div className="px-4 md:px-8 py-6 max-w-xl pb-32">
      ...
      <div className="mt-2 p-3.5 flex flex-col gap-3" style={{ background: palette.ivory, border: "1px solid rgba(26,26,26,0.1)" }}>
        ...
        <label className="block">{label("Colour")}<input value={fields.colorName} onChange={(e) => setFields((f) => ({ ...f, colorName: e.target.value }))} placeholder={`e.g. Champagne Gold (code ${design.color})`} className="font-body" style={input} /></label>
